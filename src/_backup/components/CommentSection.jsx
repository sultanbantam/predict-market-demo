...
const MOCK_COMMENTS = [
  { id: 1, user: 'DeFiGuru', text: 'ETH is definitely hitting $4k. The L2 adoption is crazy right now.', time: '2h ago', avatar: '🛡️' },
  { id: 2, user: 'CryptoWhale', text: 'I am taking the NO side. Macro conditions are too uncertain.', time: '5h ago', avatar: '🐳' },
  { id: 3, user: 'AlphaSeeker', text: 'LayerZero V3 news will be the catalyst. I am all in on YES.', time: '1d ago', avatar: '🚀' },
];
          ...
          <div key={c.id} style={{ display: 'flex', gap: '1rem' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: 'flex', gap: '12px', marginTop: '8px' }}>
                <button style={{ background: 'none', border: 'none', color: 'var(--text-muted)', fontSize: '0.75rem', cursor: 'pointer' }}>👍 Like</button>
                <button style={{ background: 'none', border: 'none', color: 'var(--text-muted)', fontSize: '0.75rem', cursor: 'pointer' }}>💬 Reply</button>
              </div>
            </div>
          </div>
        ))}
